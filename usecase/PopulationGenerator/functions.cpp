...
{
    qDebug()<<endl;
    qDebug()<<"1> Advance years"<<endl;
    qDebug()<<"2> View/Modify parameters"<<endl;
    qDebug()<<"3> Display stats"<<endl;
    qDebug()<<"0> Exit"<<endl;
    qDebug()<<"Choice: ";
}
...
int processModifyRequest (char *choice)
{
    ...
    {
        qDebug()<<"ERROR: Invalid Option selected\n";
    }
...
int simulate(int yearsToAdvance)
{
    ...
    qDebug()<<endl<<"Processing..."<<endl<<endl;
